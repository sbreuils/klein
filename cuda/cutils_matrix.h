...
inline __device__ __host__  float3x3 outer_prod_tri_order(float3 a, float3 b) {
	float3x3 res;
	res.m11 = a.x * b.x;
	res.m12 = a.x * b.y;
	res.m13 = a.x * b.z;
...
public:
	...
	inline __device__ __host__ float4x4 operator-(const float4x4& other) const {
		...
		res.m11 = m11 - other.m11;
		res.m12 = m12 - other.m12;
		res.m13 = m13 - other.m13;
		res.m14 = m14 - other.m14;

		res.m21 = m21 - other.m21;
		res.m22 = m22 - other.m22;
		res.m23 = m23 - other.m23;
		res.m24 = m24 - other.m24;

		res.m31 = m31 - other.m31;
		res.m32 = m32 - other.m32;
		res.m33 = m33 - other.m33;
		res.m34 = m34 - other.m34;

		res.m41 = m41 - other.m41;
		res.m42 = m42 - other.m42;
		res.m43 = m43 - other.m43;
		res.m44 = m44 - other.m44;
	...
	inline __device__ __host__ float4x4 operator*(const float t) const
	{
		float4x4 res;
		res.m11 = m11 * t;
		res.m12 = m12 * t;
